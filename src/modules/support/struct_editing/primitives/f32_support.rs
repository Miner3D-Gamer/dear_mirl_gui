...
impl InspectableType for f32 {
    type Inspectable = InspectF32;
...
pub struct InspectF32 {
    state: crate::modules::Slider<f32, f32>,
}
impl Inspectable for InspectF32 {
...
impl DearMirlGuiModule for InspectF32 {
    fn draw(
        &mut self,
