...
impl InspectableType for i32 {
    type Inspectable = InspectI32;
...
pub struct InspectI32 {
    state: crate::modules::Slider<f32, i32>,
}
impl Inspectable for InspectI32 {
...
impl DearMirlGuiModule for InspectI32 {
    fn draw(
        &mut self,
